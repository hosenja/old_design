...
class ProviderViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tableViewRatings.isHidden = true
    ...
    func getUrlService(){
        ...
        case "Hotels":
            ...
            let url = ApiRouts.Api+"/ratings?model_id=\((ProviderInfo.currentProviderId)!)&model_type=hotels"
            urlGetRate = url
        ...
        case "Places":
            ...
            let url = ApiRouts.Api+"/ratings?model_id=\((ProviderInfo.currentProviderId)!)&model_type=places"
             urlGetRate = url
            ProviderInfo.model_id = (ProviderInfo.currentProviderId)!
            ProviderInfo.model_type = "places"
        case "Restaurants":
            urlGetService = ApiRouts.Api+"/get/restaurant/\((ProviderInfo.currentProviderId)!)"
            let url = ApiRouts.Api+"/ratings?model_id=\((ProviderInfo.currentProviderId)!)&model_type=restaurants"
            urlGetRate = url
            ProviderInfo.model_id = (ProviderInfo.currentProviderId)!
            ProviderInfo.model_type = "restaurants"
        case "Tourguides":
            urlGetService = ApiRouts.Api+"/get/tourguide/\((ProviderInfo.currentProviderId)!)"
            let url = ApiRouts.Api+"/ratings?model_id=\((ProviderInfo.currentProviderId)!)&model_type=tourguides"
            urlGetRate = url
            ProviderInfo.model_id = (ProviderInfo.currentProviderId)!
            ProviderInfo.model_type = "tourguides"
        case "Transport":
            urlGetService = ApiRouts.Api+"/get/transport/\((ProviderInfo.currentProviderId)!)"
            let url = ApiRouts.Api+"/ratings?model_id=\((ProviderInfo.currentProviderId)!)&model_type=transports"
            urlGetRate = url
            ProviderInfo.model_id = (ProviderInfo.currentProviderId)!
            ProviderInfo.model_type = "transports"
        case "Activities":
            urlGetService = ApiRouts.Api+"/get/activity/\((ProviderInfo.currentProviderId)!)"
            let url = ApiRouts.Api+"/ratings?model_id=\((ProviderInfo.currentProviderId)!)&model_type=activities"
            urlGetRate = url
            ProviderInfo.model_id = (ProviderInfo.currentProviderId)!
        ...
        { response in
            ...
            do {
                ...
                DispatchQueue.main.sync {
                    self.tableViewRatings.isHidden = false
                    if self.ratingsArray?.count == 0 {
                        self.count = 0
