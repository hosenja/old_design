...
class AppDelegate: UIResponder, UIApplicationDelegate, MessagingDelegate, UNUserNotificationCenterDelegate {
    ...
    fileprivate func setMemberUnSign() {
        self.setToUserDefaults(value: false, key: "isLogged")
        self.setToUserDefaults(value: -1, key: "member_id")
        self.setToUserDefaults(value: nil , key: "first_name")
        self.setToUserDefaults(value: "no value", key: "last_name")
        self.setToUserDefaults(value: "no value", key: "email")
        self.setToUserDefaults(value: "no value", key: "phone")
        self.setToUserDefaults(value: "no value", key: "gender")
        self.setToUserDefaults(value: "no value", key: "birth_date")
        self.setToUserDefaults(value: "no value", key: "profile_image")
    }
    ...
    func subscribeToMyGroups(id: Int) {
        let url = ApiRouts.ApiV3+"/groups?member_id=\(id)&my_groups=true&roles[]=group_leader&roles[]=member"
        print("Url response is \(url)")
